...
Use the following steps to create a custom view that displays aggregates that are 80% or more full, and then schedule a report to be generated for that view.
...
. Save the view with a specific name that reflects what the view is showing, for example "`Aggregates nearing full`" and click the check mark (image:../media/blue-check.gif[]) .
