...
* *Exporting data*
+
You can click the export icon (image:../media/export_icon.gif[Icon for exporting comma-separated data for use in reports.]) to export data to a comma-separated values (`.csv`) file or (`.pdf`) document and use the exported data to build reports.
