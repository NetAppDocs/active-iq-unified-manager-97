...
* MySQL Community Edition version 8.0.20 or later versions in the 8.0 family (from the MySQL repository)
+
[NOTE]
====
Make sure that you have removed any previously installed version of MySQL 5.7. The base MySQL version must be 8.0.20.
====
...
+
link:task-manually-configuring-the-epel-repository.html[Manually configuring the EPEL repository]
